...
export default function AuthForm({ onSubmit, error, loading }) {
  ...
  return <form className="auth-form" onSubmit={submit}>
    ...
    <label className="remember-control"><input type="checkbox" checked={remember} onChange={event => setRemember(event.target.checked)} />Keep this secure session active</label>
