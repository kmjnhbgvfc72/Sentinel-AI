...
async def create_log(
    ...
    NotificationService(db).create_for_log(event_type=log.event_type, severity=log.severity, username=log.username, source_ip=log.source_ip, description=log.description)
